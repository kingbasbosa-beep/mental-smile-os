...
| OWNERSHIP_SPLASH_BACKGROUND_MOBILE | SPLASH_BACKGROUND_MOBILE | Splash Mobile Background | UI image background | Mental Smile | Mental Smile Core | Inherited asset | RP-SPLASH-BACKGROUND-MOBILE | Internal Platform Asset | Use inside Mental Smile OS App Surface after purification. | May modify/recreate under OS visual rules. | Internal platform use after review. | No third-party ownership discovered in this step. | assets/branding/splash/splash_mobile_v1.jpg | LINEAGE_ESTABLISHED | MEMORY_VALIDATED |
| OWNERSHIP_SPLASH_BACKGROUND_TABLET | SPLASH_BACKGROUND_TABLET | Splash Tablet Background | UI image background | Mental Smile | Mental Smile Core | Inherited asset | RP-SPLASH-BACKGROUND-TABLET | Internal Platform Asset | Use inside Mental Smile OS App Surface after purification. | May modify/recreate under OS visual rules. | Internal platform use after review. | No third-party ownership discovered in this step. | assets/branding/splash/splash_tablet_v1.jpg | LINEAGE_ESTABLISHED | MEMORY_VALIDATED |
| OWNERSHIP_SPLASH_BACKGROUND_DESKTOP | SPLASH_BACKGROUND_DESKTOP | Splash Desktop Background | UI image background | Mental Smile | Mental Smile Core | Inherited asset | RP-SPLASH-BACKGROUND-DESKTOP | Internal Platform Asset | Use inside Mental Smile OS App Surface after purification. | May modify/recreate under OS visual rules. | Internal platform use after review. | No third-party ownership discovered in this step. | assets/branding/splash/splash_web_v1.jpg | LINEAGE_ESTABLISHED | MEMORY_VALIDATED |
| OWNERSHIP_SPLASH_LANGUAGE_BUTTON | SPLASH_LANGUAGE_BUTTON | Splash Language Toggle Button | UI language element | Mental Smile | Mental Smile Core | Inherited asset | RP-SPLASH-LANGUAGE-BUTTON | Internal Platform Asset | Use inside Mental Smile OS App Surface after purification. | May modify/recreate under OS visual rules. | Internal platform use after review. | No third-party ownership discovered in this step. | assets/branding/language/en_gold.png | LINEAGE_ESTABLISHED | MEMORY_VALIDATED |
