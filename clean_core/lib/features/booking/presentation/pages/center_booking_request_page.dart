...
class _CenterBookingRequestPageState extends State<CenterBookingRequestPage> {
  ...
  Future<void> _submit() async {
    ...
    debugPrint('CENTER_DIAG entered_submit_v2');
    if (_submitting) {
    ...
    try {
      debugPrint('CENTER_TRACE before_admin_lookup');
      final admins = await _resolveCenterAdmins();
      debugPrint('CENTER_TRACE after_admin_lookup count=${admins.length}');

      debugPrint('CENTER_TRACE before_prepare_payload');
      ...
      if (shouldCreate) {
        debugPrint('CENTER_TRACE before_create_prep');
        ...
        debugPrint('CENTER_DIAG skipped_diag_write_v3');
        debugPrint('CENTER_TRACE after_create_prep');
        debugPrint('CENTER_CREATE before_create_request');
        debugPrint('CENTER_CREATE requestGroupId=$requestGroupId');
        debugPrint(
        ...
        debugPrint("CENTER_CREATE payload_clientId=${payload['clientId']}");
        debugPrint("CENTER_CREATE payload_centerId=${payload['centerId']}");
        debugPrint("CENTER_CREATE payload_centerName=${payload['centerName']}");
