...
// Observability-only construction asset. No Firebase, writes, legacy reports,
// admin archive, booking, session, payment, or assignment coupling.
class SSignalControlRoomPage extends StatelessWidget {
  const SSignalControlRoomPage({super.key});
