...
class MarketingWorkspacePage extends StatelessWidget {
  const MarketingWorkspacePage({super.key});
      ...
      body: AppPageBackground(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.md),
            Text(
              'Future smart assistant is not active here. This workspace remains manual and content-oriented only.',
              style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                    color: const Color(0xFFEAEAEA),
                    height: 1.35,
                  ),
