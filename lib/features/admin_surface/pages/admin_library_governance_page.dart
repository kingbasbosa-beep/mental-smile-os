...
class _AdminLibraryGovernancePageState
    extends State<AdminLibraryGovernancePage> {
              ...
              child: GatewaySectionCard(
                ...
                children: [
                  ...
                  _buildGovernanceCard(
                    ...
                    supervisionNote: 'هذه قاعدة حوكمة مرجعية للموافقة.',
                  ),
                ],
              ),
            ),
              ...
              child: GatewaySectionCard(
                ...
                children: [
                  ...
                  _buildGovernanceCard(
                    ...
                    boundaryNote: 'حماية الحقوق جزء أساسي من سلامة المكتبة.',
                    supervisionNote: 'لا نشر قبل وضوح الحقوق.',
                  ),
                  _buildGovernanceCard(
                    context,
                    ...
                    boundaryNote: 'الملاءمة شرط أساسي، وليست عنصرًا تجميليًا.',
                    supervisionNote: 'هذا منع تحريري/إشرافي داخل الصفحة.',
                  ),
                  _buildGovernanceCard(
                    context,
                    ...
                    supervisionNote: 'هذا حد سلامة ثابت.',
                  ),
                  _buildGovernanceCard(
                    context,
                    ...
                    supervisionNote: 'هذا حد حوكمي أساسي داخل المكتبة.',
                  ),
                  _buildGovernanceCard(
                    context,
                    ...
                    supervisionNote: 'لا نشر خارج السياسة المعتمدة.',
                  ),
                ],
              ),
            ),
            ...
            GatewaySectionCard(
              ...
              children: [
                _buildGovernanceCard(
                  ...
                  supervisionNote: 'حالة وصفية فقط داخل الحوكمة الحالية.',
                ),
                _buildGovernanceCard(
                  context,
                  title: 'under review',
                  ...
                  boundaryNote: 'هذه المرحلة هي قلب الحوكمة قبل النشر.',
                  supervisionNote:
                ...
                _buildGovernanceCard(
                  ...
                  supervisionNote: 'حالة مرجعية داخل الصفحة فقط.',
                ),
                _buildGovernanceCard(
                  context,
                  title: 'hidden',
                  ...
                  supervisionNote: 'وصف إشرافي فقط، وليس تنفيذًا فعليًا.',
                ),
                _buildGovernanceCard(
                  context,
                  title: 'archived',
                  ...
                  supervisionNote: 'حالة مرجعية فقط في هذه الصفحة.',
                ),
                _buildGovernanceCard(
                  context,
                  title: 'blocked',
            ...
            GatewaySectionCard(
              ...
              children: [
                _buildGovernanceCard(
                  ...
                  supervisionNote: 'هذا هو التوجيه الأعلى لحوكمة المكتبة.',
                ),
                _buildGovernanceCard(
                  context,
                  ...
                  supervisionNote: 'الاقتراح فقط ممكن، أما النشر فإداري فقط.',
                ),
                _buildGovernanceCard(
                  context,
