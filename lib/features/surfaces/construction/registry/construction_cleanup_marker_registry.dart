class ConstructionCleanupMarkerRegistry {
  const ConstructionCleanupMarkerRegistry._();
  ...
  static const String duplicateFunctionSweepMarker =
      'duplicate_function_sweep_marker';
  static const String visualLegacySweepMarker = 'visual_legacy_sweep_marker';
  ...
  static const Set<String> values = <String>{
    ...
    duplicateFunctionSweepMarker,
    visualLegacySweepMarker,
  };
}
