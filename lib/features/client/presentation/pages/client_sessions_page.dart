...
class ClientSessionsPage extends StatelessWidget {
  ...
  String _statusLabel(String status, bool isArabic) {
    switch (status) {
      ...
      case 'payout_pending':
        return isArabic ? 'بانتظار التحويل للأخصائي' : 'Payout pending';
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(isArabic ? 'جلساتي' : 'My Sessions'),
          leading: IconButton(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (sessionDate.trim().isEmpty &&
                                  ...
                                  Text(
                                    isArabic
                                        ? 'سيتم عرض بيانات الجلسة هنا بمجرد تجهيزها.'
                                        : 'Session details will appear here once prepared.',
                                  ),
                                ],
